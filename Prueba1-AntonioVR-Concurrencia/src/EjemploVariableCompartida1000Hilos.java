public class EjemploVariableCompartida1000Hilos extends Thread {
    ...
    public static void main(String[] args) {
        int numHilos = 1000; // Number of threads to create
        ...
        for (int i = 0; i < numHilos; i++) {
            hilos[i] = new EjemploVariableCompartida1000Hilos();
